...
//Date        : Sun Feb 28 10:58:19 2021
//Host        : Manjaro running 64-bit Manjaro Linux
//Command     : generate_target emio_key_led.bd
//Design      : emio_key_led
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "emio_key_led,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=emio_key_led,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "emio_key_led.hwdef" *) 
module emio_key_led
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  emio_key_led_processing_system7_0_0 processing_system7_0
