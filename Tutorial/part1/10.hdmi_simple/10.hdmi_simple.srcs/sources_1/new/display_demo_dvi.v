...
module display_demo_dvi(
    ...
    display_clocks #(               // 640x480  800x600 1280x720 1920x1080
        .MULT_MASTER(64),       //    31.5     10.0   37.125    37.125
        .DIV_MASTER(5),             //       5        1        5         5
        .DIV_5X(2.0),               //     5.0      5.0      2.0       1.0
        .DIV_1X(10),                //      25       25       10         5
        .IN_PERIOD(20.0)            // 100 MHz = 10 ns
    )
    display_clocks_inst
    (
       .i_clk(CLK),
    ...
    //1280x720    1280   720   64  128  192    3    5   20
    parameter SVO_MODE             =   "1280x720R";
	...
	`SVO_DECLS
    display_timings #(          
        .H_RES(SVO_HOR_PIXELS),       
        .V_RES(SVO_VER_PIXELS),           
        .H_FP(SVO_HOR_FRONT_PORCH),          
        .H_SYNC(SVO_HOR_SYNC),      
        .H_BP(SVO_HOR_BACK_PORCH),     
        .V_FP(SVO_VER_FRONT_PORCH),   
        .V_SYNC(SVO_VER_SYNC),            
        .V_BP(SVO_VER_BACK_PORCH),  
        .H_POL(1),
        .V_POL(1)
    )
...
//    )
    ...
    //    test_card_simple #(
    //        .H_RES(SVO_HOR_PIXELS)    // horizontal resolution
    //    ) test_card_inst (
    //        .i_x(sx),
    //        .o_red(red),
    //        .o_green(green),
    ...
    // // Test Card: Squares - ENABLE ONE TEST CARD INSTANCE ONLY
     test_card_squares #(
         .H_RES(SVO_HOR_PIXELS),   // horizontal resolution
         .V_RES(SVO_VER_PIXELS)     // vertical resolution
     )
     test_card_inst (
         .i_x(sx),
         .i_y(sy),
